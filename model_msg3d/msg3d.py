from model_msg3d.activation import activation_factory
from model_msg3d.mlp import MLP
from model_msg3d.ms_gtcn import SpatialTemporal_MS_GCN, UnfoldTemporalWindows
from model_msg3d.ms_tcn import MultiScale_TemporalConv as MS_TCN
from model_msg3d.ms_gcn import MultiScale_GraphConv as MS_GCN
...
class Model(nn.Module):
    def __init__(self,
        ...
        self.gcn3d1 = MultiWindow_MS_G3D(
            2, c1, A_binary, num_g3d_scales, window_stride=1)
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((125, 1))
        #if class_loss:
    ...
    def forward(self, x):
        ...
        if self.class_loss:
            #out =  self.avgpool(x)
            out_channels = out_feat.size(1)
            out = out_feat.view(N, out_channels, -1)
            #print(out.shape)
